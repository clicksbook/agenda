...
<head>
   ...
   <link href="https://fonts.googleapis.com/css?family=Mada:400,500,600" rel="stylesheet">
	...
	<!-- Font Awesome -->
	<link href="<?php echo ROUTE;?>assets/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<section class="login p-fixed d-flex text-center bg-primary common-img-bg">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="login-card card-body ml-auto mr-auto">
					<form class="md-float-material">
						<div class="text-center">
							<img src="<?php echo ROUTE;?>assets/images/logo-white.png">
						</div>
						...
						<div class="row">
							<div class="col-sm-10 offset-sm-1">
								<a href="index.html"> <button type="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">LOGIN</button> </a>
							</div>
						</div>
						<!-- <div class="card-footer"> -->
						<div class="col-sm-12 col-xs-12 text-center">
							<span class="text-muted">Don't have an account?</span>
							<a href="registro" class="f-w-600 p-l-5">Sign up Now</a>
						</div>
