                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="user-block-2">
                                <img class="img-fluid" src="<?php echo ROUTE; ?>assets/images/widget/user-1.png" alt="user-header">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <button type="button" class="btn btn-warning waves-effect waves-light m-r-30">
                                        Follows
                                    </button>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body horizontal-card-img d-flex">
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body horizontal-card-img d-flex">
                                        <img class="media-object img-circle" src="<?php echo ROUTE; ?>assets/images/lockscreen.png" alt="Generic placeholder image">
                                        <span class="d-inlineblock  p-l-20">
                                            <h6>Josephin Doe</h6>
                                            <a href="#">contact@admin.com</a>
                                        </span>
                                ...
                                <div class="table-responsive">
                                    <table class="table m-b-0 photo-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>
                                                    <img class="img-fluid img-circle" src="<?php echo ROUTE; ?>assets/images/avatar-2.png" alt="User">
                                                </th>
                                                <td>Appestia Project
                                            ...
                                            <tr>
                                                <th>
                                                    <img class="img-fluid img-circle" src="<?php echo ROUTE; ?>assets/images/avatar-4.png" alt="User">
                                                </th>
                                            ...
                                            <tr>
                                                <th>
                                                    <img class="img-fluid img-circle" src="<?php echo ROUTE; ?>assets/images/avatar-1.png" alt="User">
                                                </th>
                                            ...
                                            <tr>
                                                <th>
                                                    <img class="img-fluid img-circle" src="<?php echo ROUTE; ?>assets/images/avatar-3.png" alt="User">
                                                </th>
                                                <td>Contract with belife Company
                                                    <p><i class="icofont icofont-clock-time"></i>Created 20.10.2016</p>
                                                </td>
